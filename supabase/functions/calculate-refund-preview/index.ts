...
// Função de normalização para busca exata (importante!)
...
Deno.serve(async (req) => {
    ...
    try {
        ...
        if (propositoAluno) {
            ...
            // Opcional: Se quiser que dê erro se não achar, descomente abaixo.
            //Mas numa devolução talvez queiramos mostrar 0 mesmo.
            saldoAtual = 0;
        }
